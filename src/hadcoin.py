...
# To be installed:
# Flask==1.1.4: pip install Flask==1.1.4
# Postman HTTP Client
...
# Creating an address for the on Port 5000
...
def replace_chain():
    ...
    if is_chain_replaced:       
        response = {'message': 'THe nodes ha different chians so the chain was replaced by the longest one.',
...
# Running the app - http://127.0.0.1:5000/
